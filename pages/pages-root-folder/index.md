...
In my role as a Product Marketing Manager for UWB and IoT at <a href="https://www.nxp.com/">NXP Semiconductors</a>, I contribute to a widespread adoption of the Ultra-wideband (UWB) technology in the Internet-of-Things (IoT). I define the strategy, new use cases and business models to enhance the UWB ecosystem around the vehicle and mobile phone to enable UWB to become an integral part of the IoT and the digitalization.
